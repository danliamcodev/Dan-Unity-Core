...
- Architecture
  ...
  - [Scriptable Objects](scriptable_objects.md)
    - [Data Containers](scriptable_objects.md#data-containers)
    - [Variables](scriptable_objects.md#variables)
    - [Runtime Sets](scriptable_objects.md#runtime-sets)
    - [Event System](scriptable_objects.md#event-system)
    - [Additional Resources](scriptable_objects.md#additional-resources)
